...
# Block of code which I intergrated from my Udacity course. This helps eliminate
...
def get_forecast():
    try:
        # I integrated this block of code from my Udacity Python course which
        # improves error handling in the weather program. This elimiates ambiguity in
        # user input.
        which_place = ''
